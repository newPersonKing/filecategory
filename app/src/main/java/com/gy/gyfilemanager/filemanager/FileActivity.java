...
import com.gy.gyfilemanager.filemanager.util.ACache;
import com.gy.gyfilemanager.filemanager.util.Fab;
...
public class FileActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initView() {
        ...
        LinearLayout image =  findViewById(R.id.file_image);
        LinearLayout music = findViewById(R.id.file_music);
        LinearLayout video =  findViewById(R.id.file_video);
        LinearLayout word =  findViewById(R.id.file_word);
        LinearLayout apk = findViewById(R.id.file_apk);
        LinearLayout zip =  findViewById(R.id.file_zip);
