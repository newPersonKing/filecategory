...
import com.gy.gyfilemanager.filemanager.adapter.ImageAdapter;
...
public class ImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLoading = ret.findViewById(R.id.loading_gif);
        mRecyclerView =  ret.findViewById(R.id.id_recyclerview);
        mLoadingText =  ret.findViewById(R.id.loading_text);
        mPullToRefreshView = ret.findViewById(R.id.pull_to_refresh);
    ...
    private void judge() {
        ...
        if (!first && time != 0 & cha < 86400000) {
            Log.i("ccccccccccccc","asdastimetimetimedasd");
            for (int i = 0; i < num; i++) {
